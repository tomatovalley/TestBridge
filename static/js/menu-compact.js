...
$(document).ready(function(){
    ...
    var menu_effect_desktop="overlay";
    var menu_effect_tablet="overlay";
    var menu_effect_phone="overlay";
    var menu_icon_style="st2";
    $("#pcoded").pcodedmenu({
        themelayout:'vertical',verticalMenuplacement:'left',verticalMenulayout:layout_width,MenuTrigger:'click',
        SubMenuTrigger:'click',activeMenuClass:'active',ThemeBackgroundPattern:bgpattern,HeaderBackground:headerbg,
        LHeaderBackground:menucaption,NavbarBackground:Navbarbg,ActiveItemBackground:activeitemtheme,
        SubItemBackground:'theme2',LogoTheme:'theme6',ActiveItemStyle:'style0',ItemBorder:true,
        ItemBorderStyle:'solid',freamtype:frametype,SubItemBorder:false,DropDownIconStyle:'style1',
        menutype:menu_icon_style,layouttype:layout_type,
        FixedNavbarPosition:true,
        FixedHeaderPosition:true,
        collapseVerticalLeftHeader:true,VerticalSubMenuItemIconStyle:'style1',VerticalNavigationView:'view1',
        verticalMenueffect:{
            desktop:menu_effect_desktop,tablet:menu_effect_tablet,phone:menu_effect_phone,
        },
        defaultVerticalMenu:{
            desktop:"collapsed",tablet:"offcanvas",phone:"offcanvas",
        },
        onToggleVerticalMenu:{
            desktop:"offcanvas",tablet:"expanded",phone:"expanded",
        },
    });
    ...
    handlethemebgpattern();function handlethemeverticallayout(){
